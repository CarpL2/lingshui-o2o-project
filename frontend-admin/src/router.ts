...
const router = new Router({
  ...
  routes: [
    ...
    meta: { title: '后台登录', hidden: true, notNeedAuth: true } // ✅ 改成这
   },
    {
      path: "/404",
      component: () => import(/* webpackChunkName: "404" */ "@/views/404.vue"),
      meta: { title: "凌水校园生活服务平台", hidden: true, notNeedAuth: true }
    },
    {
      path: "/",
      component: Layout,
      ...
      children: [
        ...
        {
          path: "seckill-verify", // 访问路径变成 /seckill-verify
          component: () => import("@/views/seckill/verify.vue"),
          name: "SeckillVerify",
          meta: { 
            title: "秒杀核销",  // 菜单显示的文字
            icon: "dashboard"   // 菜单图标
