      ...
      <view class="restaurant_info_box">
        <view class="restaurant_info">
            ...
            <view class="info_top_right">
              ...
              <view class="right_details">
                ...
                <view class="details_flex">
                  ...
                  <text class="icon_text">配送费{{ shopInfoData && shopInfoData.deliveryPrice ? shopInfoData.deliveryPrice : 0 }}元</text>
                </view>
              </view>
            </view>
          </view>
          ...
          <view class="info_bottom">
            <view>
              <view class="word">凌水校园生活服务平台为学生提供服务</view>
              <view class="address">
                <icon></icon>
                {{ shopInfoData && shopInfoData.shopAddress ? shopInfoData.shopAddress : "商家店铺获取中.." }}
              </view>
            </view>
            <view>
      ...
      <view class="restaurant_menu_list" v-if="shopStatus === 1">
        <view class="type_list">
          <scroll-view scroll-y scroll-with-animation class="u-tab-view menu-scroll-view" :scroll-top="scrollTop + 100"
			...
			<view class="seckill-btn" @click="goSeckill" style="height: 100rpx; display: flex; align-items: center; justify-content: center; border-bottom: 1px solid #f6f6f6; background-color: #fff;">
			    <view style="color: #ff3300; font-weight: bold; font-size: 26rpx;">
			        限时秒杀
			    </view>
			</view>
